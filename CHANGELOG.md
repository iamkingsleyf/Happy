...
### Fixed
- Long text in the box no longer pushes the finished pic off the screen. The box scrolls inside itself and shrinks when you are not typing.

## [1.0.4] - 28/08/2026

### Fixed
- Picture jobs keep running on the server if the iPhone screen locks or a call comes in. Come back to the same page to see the pic.
